...
var SyncManager = class {
  ...
  loadConfig() {
    ...
    return {
      enabled: vscodeConfig.get("sync.enabled", true),
      apiUrl,
...
var AuthManager = class {
  ...
  async promptRegistration() {
    const dashboardUrl = vscode6.workspace.getConfiguration("commitDiary").get("dashboardUrl", "https://dashboard.commitdiary.com");
